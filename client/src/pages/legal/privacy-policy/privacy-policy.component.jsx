...
const PrivacyPolicy = () => (
  <div className='privacy-policy'>
    ...
    <p>At FreedomFit, we collect and manage user data according to the following Privacy Policy.</p>
    ...
    <p>We only use your personal information to provide you the FreedomFit services or to communicate with you about the Website or the services.</p>
